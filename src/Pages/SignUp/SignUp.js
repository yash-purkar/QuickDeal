...
export const SignUp = () => {
  ...
  return (
    <div className="login-form-container  signup-form-container">
      <h2 className="text-center top-margin margin-bottom-1 color-primary">
        Sign Up
      </h2>
      <form action="" onSubmit={(e) => e.preventDefault()}>
        <div>
          ...
          <div className="flex direction-column margin-bottom-1">
            <label
              htmlFor="email"
              className="display-inline-block bottom-margin-md top-margin"
            >
              Email
            </label>
            <input
          ...
          <div className="flex direction-column margin-bottom-1 relative">
            <label
              htmlFor="password"
              className="display-inline-block bottom-margin-md"
            >
              Password
            </label>
            <input
              ...
              name="password"
              id="password"
              className="login-password bottom-margin-md"
              placeholder="***********"
              autoComplete="off"
              onChange={(e) =>
          ...
          <p className="dont-have-acc font-sm text-center">
            ...
            <NavLink to="/login" className=" login-link sign-up-link font-bold">
              sign in
            </NavLink>
          </p>
        </div>
