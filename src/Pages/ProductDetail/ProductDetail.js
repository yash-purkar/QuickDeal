        ...
        <div className="product-detail-container flex justify-center align-center wrap">
          ...
          <div className="product-details flex direction-column justify-between">
            <div className="flex justify-between align-center">
              ...
              <div
                className="detail-star-rating rating-star "
            ...
            <div>
              {cart?.some((product) => product._id === _id) && token ? (
                <NavLink to="/cart">
                  <button className="go-to-cart" disabled={disabledBtn}>
                    Go To Cart
                  </button>
                </NavLink>
              ) : (
                <button
                  className={`${inStock ? "add-to-cart" : "out-of-stock-btn"}`}
                  disabled={!inStock || disabledBtn}
                  onClick={() =>
                    handleAddToCart(
                      product,
                      dispatch,
