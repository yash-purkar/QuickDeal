    ...
    <>
      {
        <div className="main-coupon-container flex justify-center align-center">
          <div className="coupon-container flex direction-column justify-between ">
            ...
            <label
              htmlFor="coupon10"
              className="discount-type font-md flex align-center margin-bottom-1 font-sm"
            >
              <input
                type="radio"
                name="coupon"
                ...
                onChange={() =>
                  setCouponDetails({ name: "FIRST_ORDER", value: 25 })
                }
                checked={couponDetails.value === 25}
              />
              25% OFF:FIRST_ORDER
            </label>
            <label
              htmlFor="coupon50"
              className="discount-type font-md flex align-center font-sm"
            >
              <input
                type="radio"
                name="coupon"
                className="discount-radio"
                onChange={() =>
                  setCouponDetails({ name: "SUMMER_SALE", value: 20 })
                }
                checked={couponDetails.value === 20}
              />
              20% OFF:SUMMER_SALE
            </label>
            <button
              className="apply-btn cursor-pointer"
