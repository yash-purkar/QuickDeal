...
export const Wishlist = () => {
  ...
  return (
    <>
      <div className='text-center top-margin letter-spacing'>{wishlist?.length > 0 ? <h2>{`My Wishlist(${wishlist?.length})`}</h2> :
        <div className='top-margin-5'>
          <img src={emptyWishlist} alt="empty-wishlist" className='illustrations' />
