...
export const OrderSummary = () => {
  // getting selected address details to show in summary
  const {
    orderState: {
      totalAmount,
      selectedAddr: {
  ...
  return (
    <>
      {orderedItems?.length === 0 ? (
        <div className="flex align-center direction-column top-margin-5">
          <h2 className="letter-spacing margin-bottom-1">
            Look's like your order is empty
          </h2>
          <NavLink to="/productlisting">
            <button className="shop-now cursor-pointer">Shop Now</button>
          </NavLink>
        </div>
      ) : (
        <div>
          <h1 className="text-center letter-spacing color-primary order-summary-heading">
            Order Summary
          </h1>
          <div className="order-summary-main flex justify-center">
            <div className="order-summary-container flex direction-column">
              <div>
                <p className="order-confirmed-msg font-1-2 font-bold letter-spacing bottom-margin-md">
                  Order Confirmed
                </p>
                <div className="font-09 bottom-margin-md order-detail ">
                  <p>
                    <span className="font-bold">Payment ID:</span> {payment_id}
                  </p>
                  <p>
                ...
                <div className="font- font-md delivery-address margin-bottom-11">
                  ...
                  <p className="summary-addr font-09">
                    ...
                    <div className="cart-product-card prod" key={_id}>
                      <div className="cart-product-details prod-detail">
                        ...
                        <div className="product-info">
                          <h4 className="cart-item-name prod-name">
                            {itemName}
                          </h4>
                          <p>Quantity : {qty}</p>
                          ...
                          <span className="discount get-fontsize">
                            ({discount}%OFF)
                          </span>
                        </div>
                      </div>
